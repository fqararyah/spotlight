...
def run_search(args, out_file):
    ...
    if args.hw_point:
        hw_templates = {
            'MoRV_delay': "{'num_simd_lane':16,'bit_width':8,'bandwidth':231,'l1_buf_size':122880,'l2_buf_size':98304,'subclusters':[9,32]}",
            'MoRV_edp': "{'num_simd_lane':16,'bit_width':8,'bandwidth':244,'l1_buf_size':237568,'l2_buf_size':122880,'subclusters':[33,9]}",
            'MoRVMnT_edp': "{'num_simd_lane':16,'bit_width':8,'bandwidth':185,'l1_buf_size':57344,'l2_buf_size':90112,'subclusters':[17,8]}",
            'MoRVMnT_delay': "{'num_simd_lane':16,'bit_width':8,'bandwidth':128,'l1_buf_size':40960,'l2_buf_size':147456,'subclusters':[5,59]}",
            'bo_edp_mnasnet': "{'num_simd_lane':16,'bit_width':8,'bandwidth':198,'l1_buf_size':122880,'l2_buf_size':32768,'subclusters':[14,21]}",
            'bo_edp_resnet': "{'num_simd_lane':16,'bit_width':8,'bandwidth':206,'l1_buf_size':81920,'l2_buf_size':73728,'subclusters':[9,33]}",
            'bo_edp_vgg': "{'num_simd_lane':16,'bit_width':8,'bandwidth':200,'l1_buf_size':65536,'l2_buf_size':73728,'subclusters':[33,9]}",
            'bo_edp_mobilenet': "{'num_simd_lane':15,'bit_width':8,'bandwidth':239,'l1_buf_size':139264,'l2_buf_size':32768,'subclusters':[56,5]}",
            'bo_edp_ztransformer': "{'num_simd_lane':16,'bit_width':8,'bandwidth':99,'l1_buf_size':188416,'l2_buf_size':73728,'subclusters':[299,1]}",
            'bo_delay_mnasnet': "{'num_simd_lane':16,'bit_width':8,'bandwidth':251,'l1_buf_size':122880,'l2_buf_size':147456,'subclusters':[15,20]}",
            'bo_delay_resnet': "{'num_simd_lane':16,'bit_width':8,'bandwidth':243,'l1_buf_size':237568,'l2_buf_size':221184,'subclusters':[17,16]}",
            'bo_delay_vgg': "{'num_simd_lane':16,'bit_width':8,'bandwidth':245,'l1_buf_size':81920,'l2_buf_size':106496,'subclusters':[33,9]}",
            'bo_delay_mobilenet': "{'num_simd_lane':16,'bit_width':8,'bandwidth':242,'l1_buf_size':106496,'l2_buf_size':81920,'subclusters':[34,7]}",
            'bo_delay_ztransformer': "{'num_simd_lane':16,'bit_width':8,'bandwidth':185,'l1_buf_size':163840,'l2_buf_size':212992,'subclusters':[3,83]}",
            'eyeriss_edge': "{'num_simd_lane':1,'bit_width':16,'bandwidth':256,'l1_buf_size':16384,'l2_buf_size':262144,'subclusters':[15,18]}",
            'eyeriss_cloud': "{'num_simd_lane':1,'bit_width':16,'bandwidth':256,'l1_buf_size':16777216,'l2_buf_size':268435456,'subclusters':[60,72]}",
            'nvdla_edge': "{'num_simd_lane':1,'bit_width':8,'bandwidth':256,'l1_buf_size':32768,'l2_buf_size':524288,'subclusters':[16,16]}",
            'nvdla_cloud': "{'num_simd_lane':1,'bit_width':8,'bandwidth':256,'l1_buf_size':1048576,'l2_buf_size':16777216,'subclusters':[120,120]}",
        }
