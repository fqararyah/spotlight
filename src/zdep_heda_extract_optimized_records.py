...
CONV_INPUT_DIMS = ['C', 'X', 'Y']
CONV_FILTER_DIMS = ['C', 'R', 'S', 'K']
CONV_OUT_DIMS = ['X', 'Y', 'K']

#the reason for repeating X and R is that they are effectively the same dim and parallelism on them affacts both
MATMUL_INPUT_DIMS = ['X', 'Y', 'R']
MATMUL_FILTER_DIMS = ['K', 'Y', 'R']
MATMUL_OUTPUT_DIMS = ['X', 'K']
